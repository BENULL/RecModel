...
def create_ml_dataset(batchsize=12):
    ...
    candidate_movie_col = [tf.feature_column.embedding_column(tf.feature_column.categorical_column_with_identity(key='movieId', num_buckets=1001,default_value=0), 10)]
    recent_rate_col = [
        tf.feature_column.embedding_column(tf.feature_column.categorical_column_with_identity(key='userRatedMovie1', num_buckets=1001, default_value=0), 10),
        tf.feature_column.embedding_column(tf.feature_column.categorical_column_with_identity(key='userRatedMovie2', num_buckets=1001, default_value=0), 10),
        tf.feature_column.embedding_column(tf.feature_column.categorical_column_with_identity(key='userRatedMovie3', num_buckets=1001, default_value=0), 10),
        tf.feature_column.embedding_column(tf.feature_column.categorical_column_with_identity(key='userRatedMovie4', num_buckets=1001, default_value=0), 10),
        tf.feature_column.embedding_column(tf.feature_column.categorical_column_with_identity(key='userRatedMovie5', num_buckets=1001, default_value=0), 10),
    ]
    ...
    feature_columns = dict(user_profile=user_profile,
                           context_features=context_features,
                           behavior_col=recent_rate_col,
                           candidate_col=candidate_movie_col)
